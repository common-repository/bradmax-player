...
<div class="update-nag" id="bradmax-customization-tip">
	You are using default bradmax player with version: v<?php echo esc_attr(self::BRADMAX_PLAYER_VERSION); ?>.
	<br />
	<br />
	...
	<div id="bradmax-customization-tips">
		<div class="tip">
			...
			<img alt="Sign up" onclick="bradmax_enlarge_image(this)" src="<?php echo esc_attr($plugin_url . self::CUSTOM_PLAYER_TIP_SCREEN_01); ?>" />
		...
		<div class="tip">
			...
			<img alt="Sign in" onclick="bradmax_enlarge_image(this)" src="<?php echo esc_attr($plugin_url . self::CUSTOM_PLAYER_TIP_SCREEN_02); ?>" />
			<div class="description">
		...
		<div class="tip">
			...
			<img alt="Add new player" onclick="bradmax_enlarge_image(this)" src="<?php echo esc_attr($plugin_url . self::CUSTOM_PLAYER_TIP_SCREEN_03); ?>" />
			<div class="description">
		...
		<div class="tip">
			...
			<img alt="Configure player" onclick="bradmax_enlarge_image(this)" src="<?php echo esc_attr($plugin_url . self::CUSTOM_PLAYER_TIP_SCREEN_04); ?>" />
			<div class="description">
		...
		<div class="tip">
			...
			<img alt="Generate player" onclick="bradmax_enlarge_image(this)" src="<?php echo esc_attr($plugin_url . self::CUSTOM_PLAYER_TIP_SCREEN_05); ?>" />
			<div class="description">
		...
		<div class="tip" style="height:auto;">
			<h4>Step 6: Download file and upload to WP</h4>
			<img alt="Download zip" onclick="bradmax_enlarge_image(this)" src="<?php echo esc_attr($plugin_url . self::CUSTOM_PLAYER_TIP_SCREEN_06); ?>" />
			<div class="description">
				On player versions list click button "download player js". You will download JavaScript file, which contain
				generated player.
				Then you are ready to upload bradmax_player.js file directly into
